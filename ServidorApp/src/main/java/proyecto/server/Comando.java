...
public class Comando {
    ...
    public static final String ELIMINAR_CARGO = "ELIMINAR_CARGO";
    ...
    public static final String GENERAR_REPORTE_COSTOS_EVENTOS = "GENERAR_REPORTE_COSTOS_EVENTOS";
    public static final String GENERAR_REPORTE_INVENTARIO = "GENERAR_REPORTE_INVENTARIO";
    public static final String GENERAR_REPORTE_AUDITORIA = "GENERAR_REPORTE_AUDITORIA";
